...
ACCOUNT_RISK_PER_TRADE = float(os.getenv("BTC_BOT_ACCOUNT_RISK_PER_TRADE", "0.20"))
...
TRADE_SIGNAL_SIDE_RATIO_THRESHOLD = float(os.getenv("BTC_BOT_TRADE_SIGNAL_SIDE_RATIO_THRESHOLD", "1.75"))
TRADE_SIGNAL_ORDERING_MAX_FLAT_PROBABILITY = float(os.getenv("BTC_BOT_TRADE_SIGNAL_ORDERING_MAX_FLAT_PROBABILITY", "0.30"))
...
COINALYZE_SYMBOL = os.getenv("BTC_BOT_COINALYZE_SYMBOL", "BTCUSDT_PERP.A")
...
BAR_CLOSE_BUFFER_SECONDS = float(os.getenv("BTC_BOT_BAR_CLOSE_BUFFER_SECONDS", "30"))
...
LIVE_INCREMENTAL_1D_DAYS = int(os.getenv("BTC_BOT_LIVE_INCREMENTAL_1D_DAYS", "14"))
LIVE_BOOTSTRAP_30M_BUFFER_BARS = int(os.getenv("BTC_BOT_LIVE_BOOTSTRAP_30M_BUFFER_BARS", "96"))
LIVE_BOOTSTRAP_1D_BUFFER_DAYS = int(os.getenv("BTC_BOT_LIVE_BOOTSTRAP_1D_BUFFER_DAYS", "14"))
